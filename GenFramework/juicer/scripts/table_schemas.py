movie_table = """
    CREATE TABLE `Movie` (
      ...
      `other_titles` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
...
program_crew_table = """
    CREATE TABLE `ProgramCrew` (
      ...
      `modified_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
      `last_seen` datetime NOT NULL,
      PRIMARY KEY (`program_sk`,`program_type`,`crew_sk`,`rank`),
      UNIQUE KEY `crew_sk` (`crew_sk`,`role`,`program_sk`,`program_type`),
